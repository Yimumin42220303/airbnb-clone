        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://t1.kakaocdn.net https://accounts.google.com https://cdn.channel.io https://wcs.channel.io https://cdn.portone.io https://www.googletagmanager.com https://connect.facebook.net https://www.facebook.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.channel.io https://*.channel.io",
              "img-src 'self' data: blob: https://res.cloudinary.com https://images.unsplash.com https://lh3.googleusercontent.com https://p.kakaocdn.net https://k.kakaocdn.net https://phinf.pstatic.net https://image.inicis.com https://*.public.blob.vercel-storage.com https://*.channel.io https://cf.channel.io https://cdn.channel.io https://*.cdninstagram.com https://*.fbcdn.net https://*.instagram.com https://www.google-analytics.com https://www.googletagmanager.com https://www.facebook.com",
              ...
              "connect-src 'self' https://api.cloudinary.com https://wcs.channel.io https://api.channel.io https://*.channel.io https://*.channel.app https://*.sentry.io wss://*.channel.io wss://*.desk-ws.channel.io wss://*.front-ws.channel.io https://*.portone.io https://portone.io https://*.iamport.co https://*.inicis.com https://stdpay.inicis.com https://iniweb.inicis.com https://*.instagram.com https://*.fbcdn.net https://*.cdninstagram.com https://www.google-analytics.com https://analytics.google.com https://*.google-analytics.com https://www.googletagmanager.com https://www.facebook.com https://graph.facebook.com",
            ].join("; "),
          },
