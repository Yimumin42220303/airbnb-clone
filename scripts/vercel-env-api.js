...
const sensitiveKeys = ["DATABASE_URL", "DIRECT_URL", "NEXTAUTH_SECRET", "GOOGLE_CLIENT_SECRET", "KAKAO_CLIENT_SECRET", "RESEND_API_KEY", "CLOUDINARY_API_SECRET", "CLOUDINARY_URL", "OPENAI_API_KEY", "PORTONE_API_SECRET", "BEDS24_REFRESH_TOKEN"];
