        ...
        <div className="max-w-[720px] mx-auto px-6 py-12 space-y-10">
          ...
          <article>
            ...
            <ul className="space-y-2 text-minbak-body text-minbak-gray list-none">
              <li>본 서비스는 숙박시설을 직접 운영하지 않는 숙박 예약 중개 플랫폼입니다.</li>
              <li>숙박 계약은 회원과 각 숙소 운영자(호스트) 간에 체결됩니다.</li>
              <li>회사는 예약 중개 및 결제 처리 역할을 수행합니다.</li>
              <li>숙박시설의 상태, 위생, 안전, 숙소 규정 준수 등 실제 숙박과 관련된 사항은 숙소 운영자의 책임입니다.</li>
            </ul>
          </article>
          ...
          <article>
            ...
            <ul className="space-y-2 text-minbak-body text-minbak-gray list-none">
              <li>회사는 중개 플랫폼으로서 숙소 운영자의 고의 또는 과실로 발생한 손해에 대해 책임을 지지 않습니다.</li>
              <li>천재지변, 감염병, 항공편 취소 등 불가항력 사유에 대해서는 숙소 취소 정책이 우선 적용됩니다.</li>
              <li>회원과 숙소 운영자 간 분쟁은 당사자 간 해결을 원칙으로 합니다. 다만 회사는 합리적 범위 내에서 조정을 지원할 수 있습니다.</li>
            </ul>
          </article>
