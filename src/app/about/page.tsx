      ...
      <main className="min-h-screen pt-24">
        ...
        <section className="bg-white border-b border-minbak-light-gray">
          <div className="max-w-[720px] mx-auto px-6 py-16 text-center">
            ...
            <h1 className="text-minbak-h1 font-bold text-minbak-black mb-3">
              도쿄민박 서비스 소개
            </h1>
            <p className="text-minbak-body-lg text-minbak-gray">
        ...
        <div className="max-w-[720px] mx-auto px-6 py-12 space-y-16">
          {/* Intro */}
          <section>
            <p className="text-minbak-body text-minbak-gray leading-relaxed mb-6">
              도쿄민박은 한국 여행객을 위해 만들어진 도쿄 숙소 예약 서비스입니다.
              복잡한 해외숙소 선택 과정, 언어 장벽, 예약 플랫폼 수수료로 인한 높은
              숙박 요금 때문에 불안했던 경험에서 출발했습니다.
            </p>
            <blockquote className="border-l-4 border-minbak-primary pl-5 py-2 my-6 text-minbak-body-lg text-minbak-black font-medium italic">
          ...
          {/* 우리가 도쿄민박을 운영하는 이유 */}
          <section>
            <h2 className="text-minbak-h2 font-semibold text-minbak-black mb-4">
              우리가 도쿄민박을 운영하는 이유
            </h2>
            <p className="text-minbak-body text-minbak-gray mb-6">
              도쿄 숙소의 예약만큼은 늘 쉽지 않습니다.
            </p>
            <ul className="space-y-2 text-minbak-body text-minbak-gray mb-6 list-disc list-inside">
          ...
          {/* 신뢰를 가장 중요하게 */}
          <section>
            <h2 className="text-minbak-h2 font-semibold text-minbak-black mb-6">
            ...
            <div className="space-y-8">
              ...
              <ul className="space-y-3 text-minbak-body text-minbak-gray">
              ...
              <blockquote className="border-l-4 border-minbak-primary pl-5 py-2 text-minbak-body text-minbak-black italic">
          ...
          {/* 서비스 특징 4가지 */}
          <section>
            <h2 className="text-minbak-h2 font-semibold text-minbak-black mb-8">
              도쿄민박 서비스 특징
            </h2>
          ...
          <section className="text-center py-8 border-t border-b border-minbak-light-gray">
            <h2 className="text-minbak-h2 font-bold text-minbak-black mb-3">
            ...
            <p className="text-minbak-body-lg text-minbak-black font-medium">
