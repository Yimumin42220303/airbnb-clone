  ...
  return (
    <div className="max-w-[800px] mx-auto px-6 py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="border-2 border-dashed border-airbnb-light-gray rounded-airbnb p-8 text-center bg-airbnb-bg/30">
          <input
            type="file"
            accept=".csv,.txt"
            onChange={(e) => {
            ...
            className="block w-full text-sm text-airbnb-gray file:mr-4 file:py-2 file:px-4 file:rounded-airbnb file:border-0 file:text-sm file:font-medium file:bg-rose-500 file:text-white hover:file:bg-rose-600"
          />
          <p className="mt-2 text-airbnb-caption text-airbnb-gray">
            CSV 형식. 첫 줄은 헤더(열 이름)입니다.
          </p>
        </div>
        {error && (
          <div className="p-4 rounded-airbnb bg-red-50 text-red-700 text-airbnb-body">
            {error}
          </div>
        )}
        <button
          ...
          className="w-full py-3 rounded-airbnb bg-rose-500 text-white font-medium hover:bg-rose-600 disabled:opacity-50 disabled:cursor-not-allowed"
        >
      ...
      {result && (
        <div className="mt-8 p-6 border border-airbnb-light-gray rounded-airbnb bg-white">
          <h2 className="text-airbnb-body font-semibold text-airbnb-black mb-2">
            {result.message}
          </h2>
          <ul className="space-y-1 max-h-60 overflow-y-auto text-airbnb-caption">
      ...
      <div className="mt-8 p-6 border border-airbnb-light-gray rounded-airbnb bg-airbnb-bg/30">
        <h3 className="text-airbnb-body font-semibold text-airbnb-black mb-2">
          CSV 형식 가이드
        </h3>
        ...
        <a
          ...
          className="inline-block mt-2 text-rose-500 hover:underline text-airbnb-body"
        >
          CSV 템플릿 다운로드
        </a>
      </div>
