...
export function notificationTitleToJa(koTitle: string): string {
  ...
  if (s === "호스트가 예약을 승인했어요. 48시간(2일) 이내에 결제해 주세요.")
    return "ホストが予約を承認しました。48時間（2日間）以内に支払いしてください。";
  ...
  if (s === "결제 기한이 약 24시간 남았습니다. 기한 내 결제하지 않으면 예약이 자동 취소됩니다.")
    return "支払い期限まであと約24時間です。期限内に支払いがないと予約は自動キャンセルされます。";
  if (s === "결제 기한이 약 4시간 남았습니다. 기한 내 결제하지 않으면 예약이 자동 취소됩니다.")
    return "支払い期限まであと約4時間です。期限内に支払いがないと予約は自動キャンセルされます。";
  if (s === "결제 기한이 약 15분 남았습니다. 기한 내 결제하지 않으면 예약이 자동 취소됩니다.")
    return "支払い期限まであと約15分です。期限内に支払いがないと予約は自動キャンセルされます。";
  if (s === "결제 기한(48시간)이 만료되어 예약이 자동 취소되었습니다.")
    return "支払い期限（48時間）が過ぎたため、予約は自動的にキャンセルされました。";
