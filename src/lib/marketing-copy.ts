...
export const BRAND_ONE_LINER =
  "합리적인 가격 + 한국어로 끝까지 챙기는 도쿄 숙소 예약 창구";
...
export const HOME_HERO_KO = {
  ...
  title2: "예약부터 체크아웃까지 도쿄민박이 한국어로 직접 챙깁니다",
  sub: "문의·체크인·숙박 중 문제·환불까지 한국어 책임 창구. 합리적인 요금으로 도쿄 현지 숙소를 예약하세요.",
  bullet1: "대형 플랫폼 대비 합리적인 요금",
  bullet2: "도쿄민박이 확인한 도쿄 현지 숙소",
  bullet3: "예약 전후·숙박 중 한국어 직접 운영대응",
} as const;

/** 상단 안내 배너 (ko) */
export const HOME_STATUS_BANNER_KO = {
  text: "KG이니시스 안전결제 · 예약 전 취소·환불 조건 확인 · 한국어 운영대응",
  linkLabel: "안심예약센터",
  linkHref: "/trust",
} as const;
...
export const SITE_META_KO = {
  ...
  description:
    "도쿄 현지 숙소를 합리적인 요금으로 예약하세요. 문의·체크인·숙박 중 문제·환불까지 도쿄민박이 한국어로 직접 대응합니다.",
  ogTitle: "도쿄민박 — 합리적인 가격, 한국어 운영대응",
  ogDescription:
    "예약부터 체크아웃까지 도쿄민박이 한국어 책임 창구로 함께합니다. 도쿄 현지 숙소를 합리적인 요금으로.",
} as const;
