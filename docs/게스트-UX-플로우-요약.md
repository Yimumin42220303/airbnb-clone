...
| 경로 | 내용 |
|------|------|
| **메시지창** | 호스트 승인 시 같은 대화방에 공식 메시지 1건("예약이 승인되었습니다. 아래 버튼에서 결제를 완료해 주세요."). 게스트는 **메시지창 상단** "호스트가 승인했습니다. 24시간 이내에 결제해 주세요." 배너의 **결제하기** 버튼으로 `/booking/[id]/pay` 진입 |
...
3. [ ] 호스트로 해당 예약 **승인** → 같은 대화방에 "예약이 승인되었습니다. 아래 버튼에서 결제를 완료해 주세요." 메시지가 추가되는지 확인
